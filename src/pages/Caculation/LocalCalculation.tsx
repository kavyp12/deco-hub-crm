      ...
      <div className="flex flex-col h-[calc(100vh-64px)] bg-gray-50">
        ...
        <div className="bg-white border-b px-4 md:px-6 py-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-sm z-10 w-full overflow-hidden">
          <div className="flex items-center gap-4 w-full md:w-auto">
            <Button variant="ghost" size="icon" onClick={() => navigate('/calculations/edit/' + selectionId)} className="shrink-0">
              <ArrowLeft className="h-5 w-5 text-gray-500" />
            </Button>
            <div className="min-w-0">
              <h1 className="text-lg md:text-xl font-bold flex items-center gap-2 text-gray-900 truncate">
                <Ruler className="h-4 md:h-5 w-4 md:w-5 text-blue-600 shrink-0" />
                <span className="truncate">Local Calculation</span>
              </h1>
              <p className="text-xs md:text-sm text-gray-500 truncate">Step 1: Quantities & Measurements</p>
            </div>
          </div>

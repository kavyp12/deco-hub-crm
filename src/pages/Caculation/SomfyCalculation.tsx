                ...
                <div className="bg-white border-b px-4 md:px-6 py-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-sm z-10 w-full overflow-hidden">
                    <div className="flex items-center gap-4 w-full md:w-auto">
                        ...
                        <div className="min-w-0">
                            <h1 className="text-lg md:text-xl font-bold flex items-center gap-2 text-yellow-700 truncate">
                                <Calculator className="h-4 md:h-5 w-4 md:w-5 shrink-0" />
                                <span className="truncate">Somfy Automation</span>
                            </h1>
                            <p className="text-xs md:text-sm text-gray-500 truncate">Separate GST Calculations for Track, Motor & Remote</p>
                        </div>
                    </div>
